...
while True:
    ...
    for(i,c) in enumerate(counterSahpe):
        ...
        cv2.putText(frame1,""+str(counter),(x,y-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,244,0),2)
    ...
    cv2.putText(frame1,"Vehical Counting : "+str(counter),(450,70),cv2.FONT_HERSHEY_SIMPLEX,2,(255,0,0),5)
